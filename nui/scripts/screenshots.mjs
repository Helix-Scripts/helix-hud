...
const SCENARIOS = [
  {
    name: 'full-hud',
    description: 'All clusters visible — vitals, needs, vehicle, info pills',
    status: { health: 90, armor: 72, hunger: 65, thirst: 100, stamina: 83, stress: 40 },
    vehicle: { active: true, speed: 128, rpm: 68, fuel: 72, engine: true, seatbelt: false, lightsOn: false, speedUnit: 'kmh' },
    playerInfo: { cash: 12450, bank: 85200, job: 'Mechanic', serverId: 42 },
    config: {
      ...BASE_CONFIG,
      theme: 'dark',
  ...
  {
    name: 'vitals-needs',
    description: 'On-foot — vitals and needs panels only',
    status: { health: 85, armor: 60, hunger: 70, thirst: 55, stamina: 82, stress: 0 },
    vehicle: { active: false, speed: 0, rpm: 0, fuel: 0, engine: false, seatbelt: false, lightsOn: false, speedUnit: 'kmh' },
    playerInfo: { cash: 12450, bank: 84200, job: 'LSPD Officer', serverId: 42 },
    config: { ...BASE_CONFIG, theme: 'dark' },
  },
  {
    name: 'vehicle-panel',
    description: 'Vehicle panel with speed, RPM, indicators, fuel tube',
    status: { health: 85, armor: 60, hunger: 70, thirst: 55, stamina: 78, stress: 0 },
    vehicle: { active: true, speed: 67, rpm: 45, fuel: 72, engine: true, seatbelt: true, lightsOn: true, speedUnit: 'mph' },
    playerInfo: { cash: 12450, bank: 84200, job: 'LSPD Officer', serverId: 42 },
    config: { ...BASE_CONFIG, theme: 'dark' },
  },
  {
    name: 'critical-state',
    description: 'Low stats — health ring glow, hunger warn, stress pulse',
    status: { health: 18, armor: 0, hunger: 22, thirst: 8, stress: 75, stamina: 15 },
    vehicle: { active: false, speed: 0, rpm: 0, fuel: 0, engine: false, seatbelt: false, lightsOn: false, speedUnit: 'kmh' },
  ...
  {
    name: 'full-stats',
    description: 'All stats at 100% — dimmed contextual opacity',
    status: { health: 100, armor: 100, hunger: 100, thirst: 100, stress: 0, stamina: 100 },
    vehicle: { active: false, speed: 0, rpm: 0, fuel: 0, engine: false, seatbelt: false, lightsOn: false, speedUnit: 'kmh' },
    playerInfo: { cash: 12450, bank: 84200, job: 'LSPD Officer', serverId: 42 },
    config: { ...BASE_CONFIG, theme: 'dark' },
  },
  {
    ...
    description: 'Vehicle with seatbelt warning blink active',
    status: { health: 90, armor: 50, hunger: 80, thirst: 70, stamina: 90, stress: 0 },
    vehicle: { active: true, speed: 95, rpm: 72, fuel: 38, engine: true, seatbelt: false, lightsOn: true, speedUnit: 'kmh' },
